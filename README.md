...
| | |
|---|---|
| **Languages** | 843 languages and 1,551 layouts from a data-driven registry: native scripts, InScript variants, romanized entries, CJK, even constructed ones. A fresh install picks up whatever your phone is already set to. |
