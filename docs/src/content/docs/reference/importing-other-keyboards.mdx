...
- The key popup and its border, and the corner hint.
- The toolbar: the tool icons, the circle behind them, and the active toggle.
- The suggestion strip: the suggestion text, the clip chip, and a chip's selected colours.
...
- **Elements this keyboard does not have.** FlorisBoard has a floating window, a clipboard browser and a one-handed panel that this app either draws differently or does not have.
