...
- **The one-handed rail** beside the keyboard, which used to ignore the theme completely.
...
- **Elements this keyboard does not have.** FlorisBoard's clipboard browser has dialogs and a landscape editor that this app either draws differently or does not have.
