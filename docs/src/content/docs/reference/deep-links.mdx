...
layout or language from `adb` or an automation app, send one of the broadcasts
on [Automation: adb and Tasker](/reference/automation/) instead.
...
111 screens. Four more exist and are deliberately not addressable. Three have
