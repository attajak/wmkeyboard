...
- **Vocabulary packs**, if you've downloaded any. Every card is kept ready so the nudges can show while you type, which is a few megabytes per pack. Removing packs you've finished with gives it back.
