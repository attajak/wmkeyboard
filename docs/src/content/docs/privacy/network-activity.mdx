...
- **Your server**: an address you typed in yourself, such as a LibreTranslate, SearXNG or Ollama server, a DeepL proxy, a transcription server, or a WebDAV, S3 or FTP backup.
